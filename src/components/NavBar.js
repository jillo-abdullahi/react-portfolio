...
import HomeIconImg from "../static/images/home-icon.png";
...
export default function NavBar() {
	...
	return (
		<Disclosure
			as="nav"
			className="z-50 w-full h-16 slideInFromTop transition-all duration-200 mt-2 pr-2"
		>
			{({ open }) => (
				<>
					<div className="mx-auto max-w-7xl md:pl-4 md:pr-3 pl-2 md:px-4 relative glassy rounded-xl">
