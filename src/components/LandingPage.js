...
const LandingPage = () => {
	...
	return (
		<MainViewContainer>
			<div className="flex flex-col items-center justify-center relative w-full h-full landing-hero rounded-2xl">
				<div
					...
					<div className="flex flex-col space-y-8 items-center header-title">
						...
						<div className="flex flex-col items-center space-y-2 content justify-center">
							<div className="flex items-center space-x-1">
								<WavingHand />
								<span className="text-3xl text-gray-300 font-medium">
									Hello, I am
								</span>
							</div>
							...
							<span className="font-medium pt-2 text-2xl text-gray-300">
								Full Stack Software Engineer
							</span>
							<div className="flex items-center justify-center space-x-1">
								<MapPinIcon className="text-orange h-4 w-4" />{" "}
								<span className="text-xl text-gray-300">Nairobi, Kenya</span>
							</div>
						</div>
					</div>
		...
		// 	{/* main content */}
		// 	<div
		// 		className={`${isSidebarOpen ? "ml-48" : "ml-16"} pl-2 transition-all duration-300`}
		// 	>
		// 		<div className="rounded-2xl w-full min-h-screen overflow-hidden border border-[#062828]">
		// 			<header id="home">
		...
		// 									Innovative Full Stack Software Engineer with a keen eye
		// 									for detail and a commitment to continuous learning. Armed
		// 									with a solid foundation in both front-end and back-end
		// 									development, I thrive on tackling complex challenges and
		// 									delivering elegant solutions within the web2 and web3
		// 									space.
		// 								</p>
		// 							</div>
		// 						</SlideMeIn>
		...
		// 									Here are some of my projects. For a full list, please
		// 									check out my{" "}
		// 									<a
		...
		// 								<a
		// 									// type="button"
		// 									className="sketchy relative inline-flex uppercase items-center gap-x-1.5 rounded-md bg-orange px-3 py-3 text-sm font-semibold text-blue shadow-sm hover:bg-orange/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-orange/80 cursor-pointer group transition"
