                ...
                <div className="content">
                    <div className="row">
                        <div className="description col s12 l6">
                            ...
                            <p className="paragraph">As a tenacious self-taught programmer, 
                            I use continuous iteration to produce results quickly and continuously improve products.</p>
                            <h3 className="heading-tertiary">an agile collaborator</h3>
                            <p className="paragraph">I have contributed to open source projects, 
                            worked on engineering teams, and always stay attuned to the newest frameworks.</p>
                        </div>
                        <div className="images col s12 l6">
                            ...
                            target="_blank" rel="noopener noreferrer"><img src="images/javascript.png" alt="javasript"/></a>
